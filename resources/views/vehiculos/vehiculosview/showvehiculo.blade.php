                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <div class="custom-control custom-switch custom-control-lg mb-2">
                                    ...
                                    <label class="custom-control-label" for="example-sw-custom-lg1">{{$filadocrenov->bsisa == "1"? "SI":"NO"}}</label>
                                </div>
                            </div>
                        </div>
                ...
                <form action="{{route('seguro.store')}}" method="POST" id="form_subir_seguros">
                    ...
                    <div id="body_tb_insertar_campos">
                        @foreach($datosseguro as $filadatosseguro)
                            <div class="row">
                                <div class="col-lg-1"><input type="text" value="{{$filadatosseguro->gestion}}" class="form-control"
                                                             name="campoa[]"></div>
                                <div class="col"><input type="text" value="{{$filadatosseguro->texto}}" class="form-control" name="campob[]"></div>
                                <div class="col"><input type="text" value="{{$filadatosseguro->empresa_aseguradora}}" class="form-control" name="campoc[]"></div>
                                ...
                                <div class="col"><input type="text" value="{{$filadatosseguro->archivo_subido}}" class="form-control" name="campoe[]"></div>
