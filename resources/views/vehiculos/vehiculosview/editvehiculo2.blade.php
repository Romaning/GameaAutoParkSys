                ...
                <div class="row push">
                    <div class="col-md-8 shadow p-2 mb-1 rounded">
                                ...
                                <div class="col">
                                    ...
                                    <select class="js-select2 form-control" id="clase_id" name="clase_id"
                                        ...
                                        @foreach($datosclase as $filaclase)
                                            <option value="{{$filaclase->clase_id}}" {{$filaclase->clase_id == $filavehiculo->clase_id ? "selected":""}}>
                                ...
                                <div class="col">
                                    ...
                                    <select class="js-select2 form-control" id="marca_id" name="marca_id"
                                        ...
                                        @foreach($datosmarca as $filamarca)
                                            <option
                                                value="{{$filamarca->marca_id}}"  {{$filamarca->marca_id == $filavehiculo->marca_id? "selected":""}}>
                                ...
                                <div class="col">
                                    ...
                                    <select class="js-select2 form-control" id="tipo_id" name="tipo_id"
                                        ...
                                        @foreach($datostipo as $filatipo)
                                            <option value="{{$filatipo->tipo_id}}" {{$filatipo->tipo_id == $filavehiculo->tipo_id ? "selected":""}}>
                                ...
                                <div class="col">
                                    ...
                                    <select class="js-select2 form-control" id="tipo_combustible_id"
                                        ...
                                        @foreach($datostipo_combustible as $filatipo_combustible)
                                            <option
                            value="{{$filatipo_combustible->tipo_combustible_id}}" {{$filatipo_combustible->tipo_combustible_id == $filavehiculo->tipo_combustible_id? "selected":""}}>
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col">
                                    ...
                                    <input type="text" class="form-control shadow p-2 mb-1 rounded " id="color"
                                           name="color"
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col">
                                    <label for="estado_servicio">Estado Servicio<span
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col">
                                    <label for="estado_servicio">Estado Servicio<span
                                            class="text-danger">*</span></label>
                                    <select class="js-select2 form-control" id="estado_servicio" name="estado_servicio"
                                            style="width: 100%;" data-placeholder="Escoger...">
                                        <option></option>
                                        <!-- Required for data-placeholder attribute to work with Select2 plugin -->
