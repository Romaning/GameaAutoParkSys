                ...
                @foreach($fila['images'] as $dato)
                    @foreach($dato as $atomo)
                        <div class="{{--row items-push--}} js-gallery img-fluid-100">
                            ...
                            <a class="img-link img-link-zoom-in img-thumb img-lightbox" href="{{asset('carpeta_imagenes/'.$atomo->archivo_subido.'')}}">
                                <img class="img-fluid" src="{{asset('carpeta_imagenes/'.$atomo->archivo_subido.'')}}">
                            </a>
                            {{--</div>--}}
                        </div>
